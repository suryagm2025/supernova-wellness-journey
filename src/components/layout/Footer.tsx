...
const Footer = () => {
  return (
    <footer className="bg-supernova-dark/50 border-t border-white/5 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="mailto:help@superinova.ai" className="text-gray-400 hover:text-white transition-colors">Contact Support</a></li>
              <li><Link to="/settings" className="text-gray-400 hover:text-white transition-colors">App Settings</Link></li>
            </ul>
          </div>
